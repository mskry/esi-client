...
export interface CharactersCharacterIdNotificationsGetInner {
    ...
    /**
     * 
     * @type {CharactersCharacterIdNotificationsGetInnerSenderTypeEnum}
     * @memberof CharactersCharacterIdNotificationsGetInner
     */
...
export function instanceOfCharactersCharacterIdNotificationsGetInner(value: object): value is CharactersCharacterIdNotificationsGetInner {
    ...
    if ((!('senderId' in (value as Record<string, any>)) && !('sender_id' in (value as Record<string, any>))) || ((value as Record<string, any>)['senderId'] === undefined && (value as Record<string, any>)['sender_id'] === undefined)) return false;
    if ((!('senderType' in (value as Record<string, any>)) && !('sender_type' in (value as Record<string, any>))) || ((value as Record<string, any>)['senderType'] === undefined && (value as Record<string, any>)['sender_type'] === undefined)) return false;
