...
import {
    type AlliancesAllianceIdContactsGetInner,
    AlliancesAllianceIdContactsGetInnerFromJSON,
    AlliancesAllianceIdContactsGetInnerToJSON,
} from '../models/AlliancesAllianceIdContactsGetInner';
import {
    type AlliancesAllianceIdContactsLabelsGetInner,
    AlliancesAllianceIdContactsLabelsGetInnerFromJSON,
    AlliancesAllianceIdContactsLabelsGetInnerToJSON,
} from '../models/AlliancesAllianceIdContactsLabelsGetInner';
import {
    type CharactersCharacterIdContactsGetInner,
    CharactersCharacterIdContactsGetInnerFromJSON,
    CharactersCharacterIdContactsGetInnerToJSON,
} from '../models/CharactersCharacterIdContactsGetInner';
import {
    type CorporationsCorporationIdContactsGetInner,
    CorporationsCorporationIdContactsGetInnerFromJSON,
    CorporationsCorporationIdContactsGetInnerToJSON,
} from '../models/CorporationsCorporationIdContactsGetInner';
import {
    type EsiError,
    EsiErrorFromJSON,
    EsiErrorToJSON,
...
export class ContactsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for deleteCharactersCharacterIdContacts without sending the request
     */
    async deleteCharactersCharacterIdContactsRequestOpts(requestParameters: DeleteCharactersCharacterIdContactsRequest): Promise<runtime.RequestOpts> {
    ...
    async deleteCharactersCharacterIdContactsRaw(requestParameters: DeleteCharactersCharacterIdContactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.deleteCharactersCharacterIdContactsRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for getAlliancesAllianceIdContacts without sending the request
     */
    async getAlliancesAllianceIdContactsRequestOpts(requestParameters: GetAlliancesAllianceIdContactsRequest): Promise<runtime.RequestOpts> {
    ...
    async getAlliancesAllianceIdContactsRaw(requestParameters: GetAlliancesAllianceIdContactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<AlliancesAllianceIdContactsGetInner>>> {
        const requestOptions = await this.getAlliancesAllianceIdContactsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getAlliancesAllianceIdContactsLabels without sending the request
     */
    async getAlliancesAllianceIdContactsLabelsRequestOpts(requestParameters: GetAlliancesAllianceIdContactsLabelsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['allianceId'] == null) {
            throw new runtime.RequiredError(
                'allianceId',
    ...
    async getAlliancesAllianceIdContactsLabelsRaw(requestParameters: GetAlliancesAllianceIdContactsLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<AlliancesAllianceIdContactsLabelsGetInner>>> {
        const requestOptions = await this.getAlliancesAllianceIdContactsLabelsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCharactersCharacterIdContacts without sending the request
     */
    async getCharactersCharacterIdContactsRequestOpts(requestParameters: GetCharactersCharacterIdContactsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
    ...
    async getCharactersCharacterIdContactsRaw(requestParameters: GetCharactersCharacterIdContactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CharactersCharacterIdContactsGetInner>>> {
        const requestOptions = await this.getCharactersCharacterIdContactsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCharactersCharacterIdContactsLabels without sending the request
     */
    async getCharactersCharacterIdContactsLabelsRequestOpts(requestParameters: GetCharactersCharacterIdContactsLabelsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
    ...
    async getCharactersCharacterIdContactsLabelsRaw(requestParameters: GetCharactersCharacterIdContactsLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<AlliancesAllianceIdContactsLabelsGetInner>>> {
        const requestOptions = await this.getCharactersCharacterIdContactsLabelsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCorporationsCorporationIdContacts without sending the request
     */
    async getCorporationsCorporationIdContactsRequestOpts(requestParameters: GetCorporationsCorporationIdContactsRequest): Promise<runtime.RequestOpts> {
    ...
    async getCorporationsCorporationIdContactsRaw(requestParameters: GetCorporationsCorporationIdContactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CorporationsCorporationIdContactsGetInner>>> {
        const requestOptions = await this.getCorporationsCorporationIdContactsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCorporationsCorporationIdContactsLabels without sending the request
     */
    async getCorporationsCorporationIdContactsLabelsRequestOpts(requestParameters: GetCorporationsCorporationIdContactsLabelsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['corporationId'] == null) {
            throw new runtime.RequiredError(
                'corporationId',
    ...
    async getCorporationsCorporationIdContactsLabelsRaw(requestParameters: GetCorporationsCorporationIdContactsLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<AlliancesAllianceIdContactsLabelsGetInner>>> {
        const requestOptions = await this.getCorporationsCorporationIdContactsLabelsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for postCharactersCharacterIdContacts without sending the request
     */
    async postCharactersCharacterIdContactsRequestOpts(requestParameters: PostCharactersCharacterIdContactsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
    ...
    async postCharactersCharacterIdContactsRaw(requestParameters: PostCharactersCharacterIdContactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<number>>> {
        const requestOptions = await this.postCharactersCharacterIdContactsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for putCharactersCharacterIdContacts without sending the request
     */
    async putCharactersCharacterIdContactsRequestOpts(requestParameters: PutCharactersCharacterIdContactsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
    ...
    async putCharactersCharacterIdContactsRaw(requestParameters: PutCharactersCharacterIdContactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.putCharactersCharacterIdContactsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
