...
import {
    type CharactersCharacterIdPlanetsGetInner,
    CharactersCharacterIdPlanetsGetInnerFromJSON,
    CharactersCharacterIdPlanetsGetInnerToJSON,
} from '../models/CharactersCharacterIdPlanetsGetInner';
import {
...
} from '../models/CharactersCharacterIdPlanetsPlanetIdGet';
import {
    type CorporationsCorporationIdCustomsOfficesGetInner,
    CorporationsCorporationIdCustomsOfficesGetInnerFromJSON,
    CorporationsCorporationIdCustomsOfficesGetInnerToJSON,
} from '../models/CorporationsCorporationIdCustomsOfficesGetInner';
import {
    type EsiError,
    EsiErrorFromJSON,
    EsiErrorToJSON,
...
} from '../models/UniverseSchematicsSchematicIdGet';
...
export class PlanetaryInteractionApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getCharactersCharacterIdPlanets without sending the request
     */
    async getCharactersCharacterIdPlanetsRequestOpts(requestParameters: GetCharactersCharacterIdPlanetsRequest): Promise<runtime.RequestOpts> {
    ...
    async getCharactersCharacterIdPlanetsRaw(requestParameters: GetCharactersCharacterIdPlanetsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CharactersCharacterIdPlanetsGetInner>>> {
        const requestOptions = await this.getCharactersCharacterIdPlanetsRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for getCharactersCharacterIdPlanetsPlanetId without sending the request
     */
    async getCharactersCharacterIdPlanetsPlanetIdRequestOpts(requestParameters: GetCharactersCharacterIdPlanetsPlanetIdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
    ...
    async getCharactersCharacterIdPlanetsPlanetIdRaw(requestParameters: GetCharactersCharacterIdPlanetsPlanetIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CharactersCharacterIdPlanetsPlanetIdGet>> {
        const requestOptions = await this.getCharactersCharacterIdPlanetsPlanetIdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCorporationsCorporationIdCustomsOffices without sending the request
     */
    async getCorporationsCorporationIdCustomsOfficesRequestOpts(requestParameters: GetCorporationsCorporationIdCustomsOfficesRequest): Promise<runtime.RequestOpts> {
    ...
    async getCorporationsCorporationIdCustomsOfficesRaw(requestParameters: GetCorporationsCorporationIdCustomsOfficesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CorporationsCorporationIdCustomsOfficesGetInner>>> {
        const requestOptions = await this.getCorporationsCorporationIdCustomsOfficesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getUniverseSchematicsSchematicId without sending the request
     */
    async getUniverseSchematicsSchematicIdRequestOpts(requestParameters: GetUniverseSchematicsSchematicIdRequest): Promise<runtime.RequestOpts> {
    ...
    async getUniverseSchematicsSchematicIdRaw(requestParameters: GetUniverseSchematicsSchematicIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UniverseSchematicsSchematicIdGet>> {
        const requestOptions = await this.getUniverseSchematicsSchematicIdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
