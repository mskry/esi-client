...
import {
    type CharactersCharacterIdWalletJournalGetInner,
    CharactersCharacterIdWalletJournalGetInnerFromJSON,
    CharactersCharacterIdWalletJournalGetInnerToJSON,
} from '../models/CharactersCharacterIdWalletJournalGetInner';
import {
    type CharactersCharacterIdWalletTransactionsGetInner,
    CharactersCharacterIdWalletTransactionsGetInnerFromJSON,
    CharactersCharacterIdWalletTransactionsGetInnerToJSON,
} from '../models/CharactersCharacterIdWalletTransactionsGetInner';
import {
    type CorporationsCorporationIdWalletsDivisionJournalGetInner,
...
} from '../models/CorporationsCorporationIdWalletsDivisionJournalGetInner';
import {
    type CorporationsCorporationIdWalletsDivisionTransactionsGetInner,
...
} from '../models/CorporationsCorporationIdWalletsDivisionTransactionsGetInner';
import {
    type CorporationsCorporationIdWalletsGetInner,
    CorporationsCorporationIdWalletsGetInnerFromJSON,
    CorporationsCorporationIdWalletsGetInnerToJSON,
} from '../models/CorporationsCorporationIdWalletsGetInner';
import {
    type EsiError,
    EsiErrorFromJSON,
    EsiErrorToJSON,
...
export class WalletApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getCharactersCharacterIdWallet without sending the request
     */
    async getCharactersCharacterIdWalletRequestOpts(requestParameters: GetCharactersCharacterIdWalletRequest): Promise<runtime.RequestOpts> {
    ...
    async getCharactersCharacterIdWalletRaw(requestParameters: GetCharactersCharacterIdWalletRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<number>> {
        const requestOptions = await this.getCharactersCharacterIdWalletRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for getCharactersCharacterIdWalletJournal without sending the request
     */
    async getCharactersCharacterIdWalletJournalRequestOpts(requestParameters: GetCharactersCharacterIdWalletJournalRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
    ...
    async getCharactersCharacterIdWalletJournalRaw(requestParameters: GetCharactersCharacterIdWalletJournalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CharactersCharacterIdWalletJournalGetInner>>> {
        const requestOptions = await this.getCharactersCharacterIdWalletJournalRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCharactersCharacterIdWalletTransactions without sending the request
     */
    async getCharactersCharacterIdWalletTransactionsRequestOpts(requestParameters: GetCharactersCharacterIdWalletTransactionsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['characterId'] == null) {
            throw new runtime.RequiredError(
                'characterId',
    ...
    async getCharactersCharacterIdWalletTransactionsRaw(requestParameters: GetCharactersCharacterIdWalletTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CharactersCharacterIdWalletTransactionsGetInner>>> {
        const requestOptions = await this.getCharactersCharacterIdWalletTransactionsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCorporationsCorporationIdWallets without sending the request
     */
    async getCorporationsCorporationIdWalletsRequestOpts(requestParameters: GetCorporationsCorporationIdWalletsRequest): Promise<runtime.RequestOpts> {
    ...
    async getCorporationsCorporationIdWalletsRaw(requestParameters: GetCorporationsCorporationIdWalletsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CorporationsCorporationIdWalletsGetInner>>> {
        const requestOptions = await this.getCorporationsCorporationIdWalletsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCorporationsCorporationIdWalletsDivisionJournal without sending the request
     */
    async getCorporationsCorporationIdWalletsDivisionJournalRequestOpts(requestParameters: GetCorporationsCorporationIdWalletsDivisionJournalRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['corporationId'] == null) {
            throw new runtime.RequiredError(
                'corporationId',
    ...
    async getCorporationsCorporationIdWalletsDivisionJournalRaw(requestParameters: GetCorporationsCorporationIdWalletsDivisionJournalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CorporationsCorporationIdWalletsDivisionJournalGetInner>>> {
        const requestOptions = await this.getCorporationsCorporationIdWalletsDivisionJournalRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getCorporationsCorporationIdWalletsDivisionTransactions without sending the request
     */
    async getCorporationsCorporationIdWalletsDivisionTransactionsRequestOpts(requestParameters: GetCorporationsCorporationIdWalletsDivisionTransactionsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['corporationId'] == null) {
            throw new runtime.RequiredError(
                'corporationId',
    ...
    async getCorporationsCorporationIdWalletsDivisionTransactionsRaw(requestParameters: GetCorporationsCorporationIdWalletsDivisionTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CorporationsCorporationIdWalletsDivisionTransactionsGetInner>>> {
        const requestOptions = await this.getCorporationsCorporationIdWalletsDivisionTransactionsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
