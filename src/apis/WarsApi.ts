...
export class WarsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getWars without sending the request
     */
    async getWarsRequestOpts(requestParameters: GetWarsRequest): Promise<runtime.RequestOpts> {
    ...
    async getWarsRaw(requestParameters: GetWarsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<number>>> {
        const requestOptions = await this.getWarsRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for getWarsWarId without sending the request
     */
    async getWarsWarIdRequestOpts(requestParameters: GetWarsWarIdRequest): Promise<runtime.RequestOpts> {
    ...
    async getWarsWarIdRaw(requestParameters: GetWarsWarIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WarsWarIdGet>> {
        const requestOptions = await this.getWarsWarIdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for getWarsWarIdKillmails without sending the request
     */
    async getWarsWarIdKillmailsRequestOpts(requestParameters: GetWarsWarIdKillmailsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['warId'] == null) {
            throw new runtime.RequiredError(
                'warId',
    ...
    async getWarsWarIdKillmailsRaw(requestParameters: GetWarsWarIdKillmailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CharactersCharacterIdKillmailsRecentGetInner>>> {
        const requestOptions = await this.getWarsWarIdKillmailsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
