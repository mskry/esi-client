...
const arguments_: CallOperationArguments<'DeleteFleetsFleetIdSquadsSquadId'> = { path: { "fleet_id": fleetId, "squad_id": squadId } };

// Generic mutation execution requires authorization, client enablement, and confirmation.
const response = await client.callOperation('DeleteFleetsFleetIdSquadsSquadId', arguments_, {
...
| squad_id | path | yes | integer (int64) |  |
...
| --- | --- | --- | --- | --- |
| `204` | none | `@evespace/esi-client/schemas` | `DeleteFleetsFleetIdSquadsSquadIdStatus204SuccessResponseSchema` | Squad deleted |
