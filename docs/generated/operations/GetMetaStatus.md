...
const arguments_: CallOperationArguments<'GetMetaStatus'> = {};

const response = await client.callOperation('GetMetaStatus', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetMetaStatusStatus200SuccessResponseSchema` | OK |
