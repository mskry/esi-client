...
const arguments_: CallOperationArguments<'GetCorporationsCorporationIdFacilities'> = { path: { "corporation_id": corporationId } };

const response = await client.callOperation('GetCorporationsCorporationIdFacilities', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetCorporationsCorporationIdFacilitiesStatus200SuccessResponseSchema` | OK |
