...
const arguments_: CallOperationArguments<'GetCharactersCharacterIdMailMailId'> = { path: { "character_id": characterId, "mail_id": mailId } };

const response = await client.callOperation('GetCharactersCharacterIdMailMailId', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetCharactersCharacterIdMailMailIdStatus200SuccessResponseSchema` | OK |
