...
- Stable ID: `GetUniverseAncestries`
- HTTP: `GET /universe/ancestries`
- Domain method: `client.universe.getUniverseAncestries(options?)`
- Generic call: `client.callOperation("GetUniverseAncestries", arguments, callOptions?)`
...
const data = await client.universe.getUniverseAncestries();
```
...
- Metadata result: `client.universe.withMetadata().getUniverseAncestries(...)` returns `EsiResponse<T>`.
