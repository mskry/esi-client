...
const arguments_: CallOperationArguments<'GetCharactersCharacterIdMedals'> = { path: { "character_id": characterId } };

const response = await client.callOperation('GetCharactersCharacterIdMedals', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetCharactersCharacterIdMedalsStatus200SuccessResponseSchema` | OK |
