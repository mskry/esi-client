...
const arguments_: CallOperationArguments<'GetFwStats'> = {};

const response = await client.callOperation('GetFwStats', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetFwStatsStatus200SuccessResponseSchema` | OK |
