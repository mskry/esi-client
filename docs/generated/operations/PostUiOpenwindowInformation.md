...
const arguments_: CallOperationArguments<'PostUiOpenwindowInformation'> = { query: { "target_id": 12345 } };

// Generic mutation execution requires authorization, client enablement, and confirmation.
const response = await client.callOperation('PostUiOpenwindowInformation', arguments_, {
...
| --- | --- | --- | --- | --- |
| target_id | query | yes | integer (int64) |  |
...
| --- | --- | --- | --- | --- |
| `204` | none | `@evespace/esi-client/schemas` | `PostUiOpenwindowInformationStatus204SuccessResponseSchema` | Open window request received |
