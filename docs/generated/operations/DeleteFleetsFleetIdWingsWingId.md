...
const arguments_: CallOperationArguments<'DeleteFleetsFleetIdWingsWingId'> = { path: { "fleet_id": fleetId, "wing_id": wingId } };

// Generic mutation execution requires authorization, client enablement, and confirmation.
const response = await client.callOperation('DeleteFleetsFleetIdWingsWingId', arguments_, {
...
| --- | --- | --- | --- | --- |
| `204` | none | `@evespace/esi-client/schemas` | `DeleteFleetsFleetIdWingsWingIdStatus204SuccessResponseSchema` | Wing deleted |
