...
- Stable ID: `GetDogmaEffects`
- HTTP: `GET /dogma/effects`
- Domain method: `client.dogma.getDogmaEffects(options?)`
- Generic call: `client.callOperation("GetDogmaEffects", arguments, callOptions?)`
...
const data = await client.dogma.getDogmaEffects();
```
...
- Metadata result: `client.dogma.withMetadata().getDogmaEffects(...)` returns `EsiResponse<T>`.
