...
- Stable ID: `GetUniverseSystemKills`
- HTTP: `GET /universe/system_kills`
- Domain method: `client.universe.getUniverseSystemKills(options?)`
- Generic call: `client.callOperation("GetUniverseSystemKills", arguments, callOptions?)`
...
const data = await client.universe.getUniverseSystemKills();
```
...
- Metadata result: `client.universe.withMetadata().getUniverseSystemKills(...)` returns `EsiResponse<T>`.
