...
const arguments_: CallOperationArguments<'GetCharactersMilitaryCampaignsObjectivesParticipation'> = { path: { "character_id": characterId, "objective_id": objectiveId } };

const response = await client.callOperation('GetCharactersMilitaryCampaignsObjectivesParticipation', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetCharactersMilitaryCampaignsObjectivesParticipationStatus200SuccessResponseSchema` | OK |

## Authentication

Required scopes: `esi.activity.char:read`.
