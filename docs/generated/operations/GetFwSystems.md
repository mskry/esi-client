...
- Stable ID: `GetFwSystems`
- HTTP: `GET /fw/systems`
- Domain method: `client.factionWarfare.getFwSystems(options?)`
- Generic call: `client.callOperation("GetFwSystems", arguments, callOptions?)`
...
const data = await client.factionWarfare.getFwSystems();
```
...
- Metadata result: `client.factionWarfare.withMetadata().getFwSystems(...)` returns `EsiResponse<T>`.
