...
const arguments_: CallOperationArguments<'GetFwLeaderboardsCorporations'> = {};

const response = await client.callOperation('GetFwLeaderboardsCorporations', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetFwLeaderboardsCorporationsStatus200SuccessResponseSchema` | OK |
