...
const arguments_: CallOperationArguments<'DeleteCharactersCharacterIdMailLabelsLabelId'> = { path: { "character_id": characterId, "label_id": labelId } };

// Generic mutation execution requires authorization, client enablement, and confirmation.
const response = await client.callOperation('DeleteCharactersCharacterIdMailLabelsLabelId', arguments_, {
...
| label_id | path | yes | integer (int64) |  |
...
| --- | --- | --- | --- | --- |
| `204` | none | `@evespace/esi-client/schemas` | `DeleteCharactersCharacterIdMailLabelsLabelIdStatus204SuccessResponseSchema` | Label deleted |
