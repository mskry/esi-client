...
const arguments_: CallOperationArguments<'GetCharactersAccessListsListing'> = { path: { "character_id": characterId } };

const response = await client.callOperation('GetCharactersAccessListsListing', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetCharactersAccessListsListingStatus200SuccessResponseSchema` | OK |
