...
const arguments_: CallOperationArguments<'GetUniverseCategories'> = {};

const response = await client.callOperation('GetUniverseCategories', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetUniverseCategoriesStatus200SuccessResponseSchema` | OK |
