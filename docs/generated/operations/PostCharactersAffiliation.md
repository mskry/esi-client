...
This operation is a reviewed read-like `POST` and does not use generic mutation gates. Review reason: Bulk-resolves character affiliations without changing server state.
