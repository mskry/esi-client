...
- Stable ID: `DeleteCharactersCharacterIdContacts`
- HTTP: `DELETE /characters/{character_id}/contacts`
- Domain method: `client.contacts.deleteCharactersCharacterIdContacts(characterId, options)`
- Generic call: `client.callOperation("DeleteCharactersCharacterIdContacts", arguments, callOptions?)`
...
const data = await client.contacts.deleteCharactersCharacterIdContacts(characterId, { contactIds: [12345] });
```
...
const arguments_: CallOperationArguments<'DeleteCharactersCharacterIdContacts'> = { path: { "character_id": characterId }, query: { "contact_ids": [12345] } };
...
| contact_ids | query | yes | array&lt;integer (int64)&gt; |  |
...
- Metadata result: `client.contacts.withMetadata().deleteCharactersCharacterIdContacts(...)` returns `EsiResponse<T>`.
