...
const characterId = 90000001;
declare const requestBody: NonNullable<CallOperationArguments<'PutCharactersCharacterIdContacts'>['body']>;

const arguments_: CallOperationArguments<'PutCharactersCharacterIdContacts'> = { path: { "character_id": characterId }, query: { "standing": 12345 }, body: requestBody };

// Generic mutation execution requires authorization, client enablement, and confirmation.
const response = await client.callOperation('PutCharactersCharacterIdContacts', arguments_, {
...
| --- | --- | --- | --- | --- |
| `204` | none | `@evespace/esi-client/schemas` | `PutCharactersCharacterIdContactsStatus204SuccessResponseSchema` | Contacts updated |
