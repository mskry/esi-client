...
const arguments_: CallOperationArguments<'GetDogmaAttributes'> = {};

const response = await client.callOperation('GetDogmaAttributes', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetDogmaAttributesStatus200SuccessResponseSchema` | OK |
