...
const arguments_: CallOperationArguments<'GetUniverseFactions'> = {};

const response = await client.callOperation('GetUniverseFactions', arguments_);
```
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/schemas` | `GetUniverseFactionsStatus200SuccessResponseSchema` | OK |
